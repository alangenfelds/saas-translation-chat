          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <div className="mt-10 flex items-center justify-center gap-x-6">
                <Link
                  href={"/chat"}
                  className="focus-visible: rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold
                  text-white shadow-sm outline-2 hover:bg-indigo-500 focus-visible:outline
                  focus-visible:outline-offset-2 focus-visible:outline-indigo-600 dark:text-white"
                >
                  Get Started
                </Link>
                <Link
